...
- [🆔 Auto-Generate ID Feature](#-auto-generate-id-feature) ⭐ **NEW**
...
## 🆔 Auto-Generate ID Feature

⭐ **NEW FEATURE** - Backend automatically generates primary key IDs for master data entities.

### Affected Entities

| Entity | Endpoint | ID Field | Format Example |
|--------|----------|----------|----------------|
| Ketua KS | `/ketua-ks` | `ID_KET` | `016005100001` |
| Kel Sah | `/kel-sah` | `ID_KEL` | `016005200001` |
| Data LO | `/data-lo` | `ID_LO` | `016005300001` |
| Sekretaris KS | `/sekretaris-ks` | `ID_SEKRE` | `016005400001` |
| Data AO | `/data-ao` | `ID_AO` | `016005500001` |
| Data Pengelola | `/data-pengelola` | `ID_PENG` | `016005600001` |

### ID Format Specification

**Total: 12 digits**
```
[KODE_OBORMAS][ROLE][NUMBER]
    016005       X    NNNNN
   (6 digit)  (1)   (5 digit)

Example: 016005100001
         └─ Ketua KS (role 1), number 00001
```

### Usage in Frontend

**Before (Old - Manual ID Required):**
```javascript
// ❌ ID field was REQUIRED
await api.post('/data-ao', {
  ID_AO: '016005500001',  // Manual input
  NO_AGT: '123456',
  NAMA: 'John Doe'
});
```
...
await api.post('/data-ao', {
  // No ID_AO needed - backend auto-generates
  NO_AGT: '123456',
  NAMA: 'John Doe'
});

// Response includes auto-generated ID
// { data: { ID_AO: '016005500001', ... } }
```

**Manual ID (Still Supported):**
```javascript
// Optional: Specify ID manually if needed
await api.post('/data-ao', {
  ID_AO: '016005599999',  // Custom ID (must be valid format)
  NO_AGT: '123456',
  NAMA: 'John Doe'
});
```
...
When providing ID manually:
- ✅ Must be exactly **12 digits**
- ✅ Must be **numeric only**
- ✅ Must start with **016005**
- ✅ 7th digit must match entity's role code
- ✅ Last 5 digits: **00001-99999**
...
```json
{
  ...
  "errors": {
    "ID_AO": [
      "The ID AO must be exactly 12 digits.",
...
```json
{
  ...
  "errors": {
    "ID_AO": ["The ID AO has already been taken."]
  }
}
```

📖 **Detailed Guide:** See [`FRONTEND_AUTO_GENERATE_ID_GUIDE.md`](./FRONTEND_AUTO_GENERATE_ID_GUIDE.md) for complete integration examples.
...
```javascript
{
  ...
  TGL_KUN: string(50) | nullable,
  KEGIATAN: string(50) | nullable,
  ID_PIC: string(50) | nullable,
...
### Filter Parameters (GET)
```
?NO_AGT=AGT001&ID_KS=001&ID_LO=002&page=1&per_page=20
```
...
**Table:** `kel_sah`  
**Primary Key:** `ID_KEL` ⭐ **Auto-Generated**
...
| GET | `/kel-sah/{ID_KEL}` | Show detail |
| PUT | `/kel-sah/{ID_KEL}` | Update |
| DELETE | `/kel-sah/{ID_KEL}` | Delete |

### Fields

```javascript
{
  ID_KEL: string(12) | optional (auto-generated) | primary key | format: 016005200001,
  NAMA_KEL: string(50) | nullable | unique,
  ID_KETUA: string(12) | required,
  ID_SEK: string(12) | nullable | unique,
  ID_LO: string(12) | required,
  ID_AO: string(12) | required,
  ALAMAT: string(50) | nullable,
  STAT: string(50) | nullable,
  TGL_STAT: string(50) | nullable,
  ID_PENGELOLA: string(12) | nullable
}
```

**💡 Note:** `ID_KEL` is auto-generated by backend. Leave empty when creating new records.

### Filter Parameters (GET)
```
?ID_KEL=016005200001&ID_KETUA=016005100001&ID_LO=016005300001&page=1&per_page=20
```
...
**Table:** `data_lo`  
**Primary Key:** `ID_LO` ⭐ **Auto-Generated**
...
```javascript
{
  ID_LO: string(12) | optional (auto-generated) | primary key | format: 016005300001,
  NO_AGT: string(15) | nullable,
  ID_TP: string(12) | nullable,
...
**💡 Note:** `ID_LO` is auto-generated by backend. Leave empty when creating new records.

### Filter Parameters (GET)
```
?ID_LO=016005300001&NO_AGT=AGT001&page=1&per_page=20
```
...
**Table:** `data_ao`  
**Primary Key:** `ID_AO` ⭐ **Auto-Generated**
...
| GET | `/data-ao/{ID_AO}` | Show detail |
| PUT | `/data-ao/{ID_AO}` | Update |
| DELETE | `/data-ao/{ID_AO}` | Delete |

### Fields

```javascript
{
  ID_AO: string(12) | optional (auto-generated) | primary key | format: 016005500001,
  NO_AGT: string(15) | nullable | unique,
  NAMA: string(50) | nullable,
  STAT: string(50) | nullable,
  TGL_STAT: string(50) | nullable
}
...
**💡 Note:** `ID_AO` is auto-generated by backend. Leave empty when creating new records.

### Filter Parameters (GET)
```
?ID_AO=016005500001&NO_AGT=AGT001&page=1&per_page=20
```
...
| GET | `/data-jlh-keluarga/{NO_AGT}` | Show detail |
| PUT | `/data-jlh-keluarga/{NO_AGT}` | Update |
| DELETE | `/data-jlh-keluarga/{NO_AGT}` | Delete |
...
{
  NO_AGT: string(15) | required | primary key,
  JLH_AGT_KEL: string(50) | nullable,
  TGL: string(50) | nullable
}
```

### Filter Parameters (GET)
```
?NO_AGT=AGT001&page=1&per_page=20
```
...
**Table:** `ketua_ks`  
**Primary Key:** `ID_KET` ⭐ **Auto-Generated**
...
```javascript
{
  ID_KET: string(12) | optional (auto-generated) | primary key | format: 016005100001,
  NO_AGT: string(15) | required | unique,
  NAMA: string(50) | nullable,
  STAT: string(50) | nullable,
  TGL_STAT: string(50) | nullable,
...
**💡 Note:** `ID_KET` is auto-generated by backend. Leave empty when creating new records.

### Filter Parameters (GET)
```
?ID_KET=016005100001&NO_AGT=AGT001&page=1&per_page=20
```
...
**Table:** `sekre_ks`  
**Primary Key:** `ID_SEKRE` ⭐ **Auto-Generated**
...
```javascript
{
  ID_SEKRE: string(12) | optional (auto-generated) | primary key | format: 016005400001,
  NO_AGT: string(15) | required | unique,
  NAMA: string(50) | nullable,
  STAT: string(50) | nullable,
  TGL_STAT: string(50) | nullable,
...
**💡 Note:** `ID_SEKRE` is auto-generated by backend. Leave empty when creating new records.

### Filter Parameters (GET)
```
?ID_SEKRE=016005400001&NO_AGT=AGT001&page=1&per_page=20
```
...
**Primary Key:** `ID_PENG` ⭐ **Auto-Generated**

### Endpoints

| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/data-pengelola` | List (paginated) |
| POST | `/data-pengelola` | Create new |
| GET | `/data-pengelola/{ID_PENG}` | Show detail |
| PUT | `/data-pengelola/{ID_PENG}` | Update |
| DELETE | `/data-pengelola/{ID_PENG}` | Delete |

### Fields

```javascript
{
  ID_PENG: string(12) | optional (auto-generated) | primary key | format: 016005600001,
  NO_AGT: string(15) | nullable,
  NO_SK: integer | nullable
}
```

**💡 Note:** `ID_PENG` is auto-generated by backend. Leave empty when creating new records.

### Filter Parameters (GET)
```
?ID_PENG=016005600001&NO_AGT=AGT001&page=1&per_page=20
```
...
| GET | `/data-penghasilan/{NO_AGT}` | Show detail |
| PUT | `/data-penghasilan/{NO_AGT}` | Update |
| DELETE | `/data-penghasilan/{NO_AGT}` | Delete |
...
{
  NO_AGT: string(15) | required | primary key,
  PENGHASILAN: string(50) | nullable,
  PENGELUARAN: string(50) | nullable,
  TGL_DATA: string(50) | nullable
}
```
