...
**Table:** `kel_sah`  
**Primary Key:** `ID_KEL` ⭐ **Auto-Generated** (was `ID_KS` in docs, actual field is `ID_KEL`)
...
**Table:** `data_ao`  
**Primary Key:** `ID_AO` ⭐ **Auto-Generated** (not `NO_AO`)
...
| GET | `/data-ao/{data_ao}` | Show detail |
| PUT | `/data-ao/{data_ao}` | Update |
| DELETE | `/data-ao/{data_ao}` | Delete |
